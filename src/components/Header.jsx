  ...
  return (
    <div className="bg-[url('../../images/Heropage.png')] bg-cover z-10 font-Gilroy ">
        ...
        <div className='text-center relative mt-32 inline w-[49%] z-10 mb-40'>
            ...
            <button className='absolute text-white bg-accent rounded-[41px] py-2 px-6 right-2 top-[0.45rem] flex items-center font-Gilroybold  gap-2 '><img src="./images/search-icon.svg" className='w-3' alt="" />Search</button>
        </div>
        </div>
    </div>
  )
